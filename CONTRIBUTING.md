...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/venikman/hapi-testing-server/labels/bug) and [easy](https://github.com/venikman/hapi-testing-server/labels/easy) vs [hard](https://github.com/venikman/hapi-testing-server/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
